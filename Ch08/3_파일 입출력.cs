...
namespace Ch08
{
    internal class _3_파일_입출력
    {
        static void Main(string[] args)
        {
            ...
            ///파일 읽기,쓰기
            ////////////////////////
            string feil1 = "C:\\Users\\601\\Desktop\\Sample1.txt";
            string feil2 = "C:\\Users\\601\\Desktop\\Sample2.txt";

            try 
            { 
                //using 선언으로 스트림 자원해제 자동 실행
              using  StreamReader reader = new StreamReader(new FileStream(feil1, FileMode.Open));
              using  StreamWriter writer = new StreamWriter(new FileStream(feil2, FileMode.OpenOrCreate));
